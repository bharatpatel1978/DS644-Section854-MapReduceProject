...
This file will have the dns names of all the data nodes in the cluster. It needs paswordless SSH to be setup across the cluster. Alternate way to estabilsh connection could be to specify the IP Addresses. Each node name or IP will be on a new line.
